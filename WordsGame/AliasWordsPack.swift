...
extension AliasWordsPack {
    ...
    static func getAliasWordsCategoriesJSON() -> [AliasWordsPack] {
        
        let sampleWordsPack = AliasWordsPack(title: "Животные",
                                             words: [
                                              "Осел",
                                              "Жираф",
                                              "Бегемот",
        ...
        let aliasWordPacks = AliasDataManager.fetchData() ?? [sampleWordsPack]
